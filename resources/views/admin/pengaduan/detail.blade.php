                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div
                            ...
                            <div class="d-flex gap-2 me-3">
                                <a href="{{ route('admin.feedback.create', $pengaduan->id_pengaduan) }}" class="btn btn-success btn-sm">
                                    <i class="bi bi-plus-circle"></i> <span class="d-none d-md-inline">Berikan
                                        Feedback</span>
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge {{ $pengaduan->status == 'ditutup' ? 'bg-secondary' : 'bg-info' }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/foto-pengaduan/' . $pengaduan->foto) }}"
                                                        class="img-thumbnail" style="max-height: 400px; max-width: 100%;"
