                    ...
                    <ul class="menu">
                        @if (Auth::check())
                            @if (Auth::user()->role == 'kepala_sekolah')
                                @if (Auth::user()->tb_kepala_sekolahs)
                                    <li class="sidebar-title">Selamat Datang,
                                        {{ Auth::user()->tb_kepala_sekolahs->nama }}
                                    </li>
                                @endif
                            @elseif (Auth::user()->role == 'petugas')
                                @if (Auth::user()->tb_petugas)
                                    <li class="sidebar-title">Selamat Datang, {{ Auth::user()->tb_petugas->nama }}</li>
                                @endif
                            @elseif (Auth::user()->role == 'siswa')
                                @if (Auth::user()->tb_siswa)
                                    <li class="sidebar-title">Selamat Datang, {{ Auth::user()->tb_siswa->nama }}</li>
                                @endif
                            @endif
                        @endif
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="{{ url('kepala_sekolah') }}" class="submenu-link">Kepala Sekolah</a>
                                </li>
                                <li class="submenu-item  ">
